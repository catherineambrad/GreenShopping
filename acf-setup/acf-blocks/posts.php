...
<section class="last-posts mt-12 mb-14">
    <div class="container">
        <h2 class="last-posts-title text-dark-grey font-bold text-center mb-4">Our Blog Posts</h2>
        <p class="last-posts-text text-grey text-center mb-6">We are an online plant shop offering a wide range of cheap and trendy plants. </p>
        <ul class="last-posts-list grid gap-11 grid-cols-4">
            <?php if ($query->have_posts()) :
                while ($query->have_posts()) : $query->the_post(); ?>
                    <li class="last-posts-list--item">
                        ...
                        <div class="last-posts-list--item-wrap-inf py-2 px-4 ">
                            ...
                            <a href="<?php the_permalink(); ?>" class="last-posts-list--item-link font-medium mt-2 flex items-center gap-1.5">Read More
                ...
                echo '<p>' . __('No posts', 'textdomain') . '</p>';
            endif;
            ?>
        </ul>
    </div>
